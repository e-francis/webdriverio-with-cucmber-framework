 ...
 * @param tagOrOption An optional tag or hook options object.
 */
export declare function beforeAll(tagOrOption?: string | HookOptions): MethodDecorator;
/**
 * A method decorator that marks the associated function as an 'After Scenario' step. The function is
 * executed after each scenario.
 *
 * @param tagOrOption An optional tag or hook options object.
 */
export declare function afterAll(tagOrOption?: string | HookOptions): MethodDecorator;
export {};
