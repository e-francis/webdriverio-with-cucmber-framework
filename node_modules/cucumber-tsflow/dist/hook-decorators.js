(function (factory) {
     ...
     * @param tagOrOption An optional tag or hook options object.
     */
    function beforeAll(tagOrOption) {
        return createHookDecorator(step_binding_1.StepBindingFlags.beforeAll, tagOrOption);
    }
     ...
     * @param tagOrOption An optional tag or hook options object.
     */
    function afterAll(tagOrOption) {
        return createHookDecorator(step_binding_1.StepBindingFlags.afterAll, tagOrOption);
    }
