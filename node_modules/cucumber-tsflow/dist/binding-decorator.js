(function (factory) {
    ...
    const ensureSystemBindings = _.once(() => {
        (0, cucumber_1.Before)(function (scenario) {
            ...
            const scenarioContext = new managed_scenario_context_1.ManagedScenarioContext(scenario.pickle.name, _.map(scenario.pickle.tags, (tag) => tag.name));
    ...
    function bindStepDefinition(stepBinding) {
        const bindingFunc = function () {
            ...
            return bindingObject[matchingStepBindings[0].targetPropertyKey]
